...
export default function TrophyPage({ game, option }) {
  ...
  console.log(data)
  return (
    <div className='trophy-border text-style'>
      <div className='cover-border' style={containerStyle} loading="lazy">
        ...
        <div className='name-platform'>
          ...
          <a href={data.TrophyListURL} target="_blank" rel="noopener noreferrer" > Trophies </a>
        </div>
      </div>
    </div>
  )
